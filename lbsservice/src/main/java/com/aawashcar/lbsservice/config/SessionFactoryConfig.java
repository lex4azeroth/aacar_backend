...
@MapperScan("com.aawashcar.lbsservice.mappers")
public class SessionFactoryConfig {
    ...
    private String typeAliasPackage = "com.aawashcar.lbsservice.entities";
    ...
    public SqlSessionFactoryBean createSqlSessionFactoryBean() {
        ...
        try {
            ...
            sqlSessionFactoryBean.setMapperLocations(resolver.getResources("classpath:com/aawashcar/lbsservice/mappers/*.xml"));
